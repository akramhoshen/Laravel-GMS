...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2024 at 07:37 PM
...
INSERT INTO `core_buyers` (`id`, `name`, `mobile`, `email`, `created_at`, `updated_at`, `address`, `photo`) VALUES
...
(7, 'Jimi Arlon', '+6145890789', 'Jimi@gmail.com', '2024-03-16 18:16:07', '2024-03-16 18:16:07', 'Australia', '1710634567.jpg'),
...
(16, 'Sabbir Hasan Rajib', '0106211100020', 'sbirjib@yahoo.com', '2024-05-07 01:22:15', '2024-05-07 01:23:25', 'Sosur Bari jindabad, to Basha..', '1715066535.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `core_fabrics`
--

CREATE TABLE `core_fabrics` (
...
--
-- Dumping data for table `core_fabrics`
--

INSERT INTO `core_fabrics` (`id`, `style_id`, `name`, `description`, `photo`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_images` (`id`, `name`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_measurement_attachments`
--

CREATE TABLE `core_measurement_attachments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `style_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `photo` varchar(255) NOT NULL,
...
--
-- Dumping data for table `core_measurement_attachments`
--

INSERT INTO `core_measurement_attachments` (`id`, `style_id`, `name`, `photo`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_measurement_sizes`
--

CREATE TABLE `core_measurement_sizes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `style_id` int(11) NOT NULL,
...
--
-- Dumping data for table `core_measurement_sizes`
--

INSERT INTO `core_measurement_sizes` (`id`, `style_id`, `measurement_id`, `size_id`, `measurement`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_mesurments`
--

CREATE TABLE `core_mesurments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `style_id` int(11) NOT NULL,
...
--
-- Dumping data for table `core_mesurments`
--

INSERT INTO `core_mesurments` (`id`, `style_id`, `code`, `name`, `tolerance`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_orders` (`id`, `style_id`, `buyer_id`, `order_date`, `delivery_date`, `shipping_address`, `status_id`, `order_total`, `paid_amount`, `remark`, `discount`, `vat`, `created_at`, `updated_at`) VALUES
...
(5, 2, 2, '2024-04-03 00:00:00', '2024-04-03 00:00:00', 'aaa', 1, 517.5, 0, 'aa', 50.00, 67.50, '2024-04-03 00:50:48', '2024-04-03 00:50:48'),
(6, 2, 2, '2024-04-03 00:00:00', '2024-04-03 00:00:00', 'NA', 1, 517.5, 0, 'NA', 50.00, 67.50, '2024-04-03 00:51:19', '2024-04-03 00:51:19'),
...
(14, 1, 7, '2024-04-16 00:00:00', '2024-04-20 00:00:00', 'NA', 4, 756, 756, 'NA', 0.00, 0.00, '2024-04-16 06:52:35', '2024-04-16 06:52:35'),
...
INSERT INTO `core_order_details` (`id`, `order_id`, `size_id`, `qty`, `price`, `discount`, `vat`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_products` (`id`, `name`, `description`, `image`, `price`, `category_id`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_raw_materials` (`id`, `style_id`, `rm_category_id`, `name`, `description`, `uom_id`, `unit_price`, `photo`, `vendor_id`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_raw_material_categories`
--

CREATE TABLE `core_raw_material_categories` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `core_raw_material_categories`
--

INSERT INTO `core_raw_material_categories` (`id`, `name`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_sizes`
--
...
--
-- Dumping data for table `core_sizes`
--

INSERT INTO `core_sizes` (`id`, `name`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_styles`
--

CREATE TABLE `core_styles` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `code` varchar(255) NOT NULL,
...
--
-- Dumping data for table `core_styles`
--

INSERT INTO `core_styles` (`id`, `code`, `style_category_id`, `description`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_style_attachments`
--

CREATE TABLE `core_style_attachments` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `core_style_attachments`
--

INSERT INTO `core_style_attachments` (`id`, `attachment`, `style_id`, `created_at`, `updated_at`) VALUES
(1, '1710397749.jpg', 1, '2024-03-14 00:29:09', '2024-03-14 02:04:06');

-- --------------------------------------------------------

--
-- Table structure for table `core_style_categories`
--

CREATE TABLE `core_style_categories` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `core_style_categories`
--

INSERT INTO `core_style_categories` (`id`, `name`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_style_material_quantities`
--

CREATE TABLE `core_style_material_quantities` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `style_id` int(11) NOT NULL,
...
--
-- Dumping data for table `core_style_material_quantities`
--

INSERT INTO `core_style_material_quantities` (`id`, `style_id`, `raw_material_id`, `size_id`, `quantity`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_style_sizes`
--

CREATE TABLE `core_style_sizes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `style_id` int(11) NOT NULL,
  `size_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `core_style_sizes`
--

INSERT INTO `core_style_sizes` (`id`, `style_id`, `size_id`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_style_trims`
--

CREATE TABLE `core_style_trims` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `style_id` int(11) NOT NULL,
...
--
-- Dumping data for table `core_style_trims`
--

INSERT INTO `core_style_trims` (`id`, `style_id`, `trim_id`, `description`, `photo`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `core_trims`
--

CREATE TABLE `core_trims` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(255) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `core_trims`
--

INSERT INTO `core_trims` (`id`, `name`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_uoms` (`id`, `name`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `core_vendors` (`id`, `organization`, `contact_person`, `phone`, `email`, `address`, `created_at`, `updated_at`) VALUES
...
--
-- Indexes for table `core_fabrics`
--
ALTER TABLE `core_fabrics`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `core_measurement_attachments`
--
ALTER TABLE `core_measurement_attachments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_measurement_sizes`
--
ALTER TABLE `core_measurement_sizes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_mesurments`
--
ALTER TABLE `core_mesurments`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `core_raw_material_categories`
--
ALTER TABLE `core_raw_material_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_sizes`
--
ALTER TABLE `core_sizes`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `core_styles`
--
ALTER TABLE `core_styles`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_style_attachments`
--
ALTER TABLE `core_style_attachments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_style_categories`
--
ALTER TABLE `core_style_categories`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_style_material_quantities`
--
ALTER TABLE `core_style_material_quantities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_style_sizes`
--
ALTER TABLE `core_style_sizes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_style_trims`
--
ALTER TABLE `core_style_trims`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `core_trims`
--
ALTER TABLE `core_trims`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `core_fabrics`
--
ALTER TABLE `core_fabrics`
...
--
-- AUTO_INCREMENT for table `core_images`
--
ALTER TABLE `core_images`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `core_measurement_attachments`
--
ALTER TABLE `core_measurement_attachments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `core_measurement_sizes`
--
ALTER TABLE `core_measurement_sizes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `core_mesurments`
--
ALTER TABLE `core_mesurments`
...
--
-- AUTO_INCREMENT for table `core_raw_material_categories`
--
ALTER TABLE `core_raw_material_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `core_sizes`
--
ALTER TABLE `core_sizes`
...
--
-- AUTO_INCREMENT for table `core_styles`
--
ALTER TABLE `core_styles`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `core_style_attachments`
--
ALTER TABLE `core_style_attachments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `core_style_categories`
--
ALTER TABLE `core_style_categories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `core_style_material_quantities`
--
ALTER TABLE `core_style_material_quantities`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `core_style_sizes`
--
ALTER TABLE `core_style_sizes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `core_style_trims`
--
ALTER TABLE `core_style_trims`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `core_trims`
--
ALTER TABLE `core_trims`
